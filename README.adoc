...
:url-repo: https://github.com/hyperpolymath/asdf-bebop-plugin
...
image:https://img.shields.io/github/license/hyperpolymath/asdf-bebop-plugin?style=flat-square[License,link=LICENSE]
image:https://img.shields.io/github/v/release/hyperpolymath/asdf-bebop-plugin?style=flat-square[Release,link={url-repo}/releases]
image:https://img.shields.io/github/actions/workflow/status/hyperpolymath/asdf-bebop-plugin/ci.yml?branch=main&style=flat-square[Build Status,link={url-repo}/actions]
image:https://img.shields.io/badge/asdf-plugin-blue?style=flat-square[asdf Plugin,link={url-asdf}]

[.lead]
An {url-asdf}[asdf] plugin to install and manage {url-tool}[Bebop] versions.
...
Bebop is an upstream tool managed by this plugin. Refer to the official
...
|**Version Switching**
|Switch between Bebop versions per project

|**Project Isolation**
|Pin Bebop per repository via `.tool-versions`

|**Reproducible Builds**
|Align CI/CD and developer environments to the same Bebop version
...
=== Installing Bebop Versions

[source,bash]
----
asdf list all bebop
asdf install bebop latest
asdf install bebop 0.1.0
----
...
[source,bash]
----
asdf global bebop 0.1.0
asdf local bebop 0.1.0
asdf current bebop
bebop --version
----
...
* Ensure `bebop` is on PATH after installation.
* Verify the installed version with `bebop --version`.
